...
class Settings(BaseSettings):
    ...
    arcmind_api_key: str = Field(default="", alias="ARCMIND_API_KEY")
    ...
    ollama_default_model: str = Field(default="qwen3:8b", alias="OLLAMA_DEFAULT_MODEL")
